...
public class Volume {
    ...
    public int pointPositionToLine(Line2D line2D,Point2D point){
     ...
     */
    public ArrayList<Point2D> caculateTanPoints(Point2D point,Volume volume) throws Exception{
         ...
         */
        Double xp1 = ((-2)*r*r*x0 + 2*x0*x0*x0 + 2*r*r*x1 - 4*x0*x0*x1 + 2*x0*x1*x1 + 2*x0*y0*y0 - 4*x0*y0*y1 + 2*x0*y1*y1
